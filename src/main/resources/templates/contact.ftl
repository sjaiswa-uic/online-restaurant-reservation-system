	...
	<div class="header-top">
		<div class="container">
			<div class="header-top-left animated wow slideInLeft" data-wow-delay=".5s">
				<p>IDS 527 Informatio, Infrastructure & Security : Group Number 13</p>
			</div>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li><a href="/smriti/summary">Home</a></li>
...
<!-- contact -->
	<div class="contact">
		<div class="container">
			<div class="contact-map animated wow slideInUp" data-wow-delay=".5s">
			...
			<div class="contact_top">
				...
				<div class="col-md-4 company-right animated wow slideInRight" data-wow-delay=".5s">
