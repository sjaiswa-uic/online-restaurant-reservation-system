				...
				<div id="loginContainer login"><a href="#" id="loginButton"><span>Login</span></a>
					<div id="loginBox" 
						...
						<form id="loginForm" action="login" method="post">
							<fieldset id="body">
								<#if loginError??>
									<h3 style="color:#FF0000;position;text-align: center;padding:1.2em 0 0;">${loginError}</h3>
								</#if>
								<fieldset>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="active"><a href="/smriti/loadlogin">Home</a></li>
						<li><a href="/smriti/contact">Contact Us</a></li>
						<li>
					</li>
					</ul>
				</div><!-- /.navbar-collapse -->
		...
		<div class="banner-pos banner1">
			<div class="container">
				<div class="banner-info animated wow slideInUp" data-wow-delay=".5s">
					<h2>
						Welcome To  Smriti <span>Restaurant</span>
					</h2>
			...
			<div class="banner-posit animated wow zoomIn" data-wow-delay=".5s">
					...
					<#if !registrationStatus??>
  						<h2></span>Register as a New User</h2>
					<#elseif registrationStatus! == "success">
						<h2></span>Registration successful. Please Login !</h2>
					<#else>
  						<h2></span>Error while Registering. Please correct your input and try again!</h2>
					</#if>
					
					<#if registrationError??>
						<h3 style="color:#0000CD;position;text-align: center;padding:1.2em 0 0;">${registrationError}</h3>
					</#if>
		...
		<div class="container">
			<div class="banner-bottom-grids">
				...
				<div class="col-md-4 banner-bottom-grid animated wow slideInLeft" data-wow-delay=".7s">
					<h3>Location</h3>
					<p>Douglas Hall,<span>University of Illinois at Chicago.</span>Chicago.</p>
				</div>
